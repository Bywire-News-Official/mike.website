...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    setEmail(["michael", "bywire.news"].join("@"));
    ...
    <Layout>
      ...
      <div className="page megaMargin p-3 whitebk">
        ...
        <div className="social-icons mt-3">
          <a className="m-2" href="https://twitter.com/bywirenews" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faTwitter} size="1x" />
          </a>
          <a className="m-2" href="https://facebook.com/heavymossman" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faFacebook} size="1x" />
          </a>
          <a className="m-2" href="https://instagram.com/ukfactcheckpolitics" target="_blank" rel="noopener noreferrer">
